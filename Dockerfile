...
RUN npm install linkify-urls@3.1.1
RUN npm install follow-redirects@1.15.2
RUN npm install get-mp3-duration@1.0.0
...
RUN npm install cache-manager@4.0.1
RUN npm install cache-manager-sqlite@0.2.0

# 這個會很常壞，所以要放到最後安裝
RUN npm install ytdl-core@4.11.4
